...
#         print(e_word)
        ...
        #print("####",i)
            ...
            h_word = h_word_with_occ[0]
            h_occurence = h_word_with_occ[1]
            if h_occurence >= (e_occurence*0.4 ) :
                str1=e_word+" <> "+h_word
#                 print(str1)
            ...
            unknown.append(e_word)
def dict_creation() :
    with open("Output/Multi_word_2.txt","w") as mul :
        print("CONFIRM MULTI-WORD MEANING")
        for i in multi_word :
            print(i)
            mul.write(i+"\n")
    with open("Output/Single_word_2.txt","w") as confirm :
        print("CONFIRM MEANING")
        for i in single_word :
            print(i)
            confirm.write(i+"\n")
    with open("Output/Probable_dict_2.txt","w") as probable :
        print("PROBABLE MEANING")
        for i in probable_word :
            print(i)
            probable.write(i+"\n")
    with open("Output/Unknown_word_list_2.txt","w") as un :
        print("UNKNOWN WORDS")
        for i in unknown :
            print(i)
            un.write(i+"\n")
